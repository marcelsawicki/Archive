<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lab3.aspx.cs" Inherits="lab3_1._Default" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button ID="Button5" runat="server" Text="   =    " style="margin-left: 34px" />
        ...
        <asp:Button ID="Button6" runat="server" Text="   =    " style="margin-left: 35px" />
        ...
        <asp:Button ID="Button7" runat="server" Text="   =    " style="margin-left: 38px" Width="54px" />
