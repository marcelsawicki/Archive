...
public class DepartamentApplication 
{
    ...
    public CommandLineRunner demoPerson(AppUserRepository appUserRepository, 
        ...
        return (args) -> {
			...
			appUserRepository.save(new App_User("programmer2", "password","Henryk1", "Pilecki1", "software developer", 21000L,3000L, new Date(2019, 11, 2)));
			appUserRepository.save(new App_User("programmer3", "password","Henryk2", "Pilecki2", "software developer", 21000L,3000L, new Date(2019, 11, 2)));
			appUserRepository.save(new App_User("programmer4", "password","Henryk3", "Pilecki3", "software developer", 21000L,3000L, new Date(2019, 11, 2)));
