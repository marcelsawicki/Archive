...
public class AppUserService implements IAppUserService 
{
	...
	public long sumPayment(String firstname, String lastname)
	{
		App_User app_user = appUserRepository.findByFirstNameAndLastName(firstname, lastname);
		long payment = app_user.getPay();
		
		long result = 12*payment;
