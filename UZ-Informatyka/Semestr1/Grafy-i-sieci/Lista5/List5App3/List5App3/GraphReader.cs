...
namespace List5App3
{
    class GraphReader
    {
        ...
        public static void SaveWithWeight(Graph graph)
        {
            ...
            lines[lines.Length - 1] = "}";
            using (System.IO.StreamWriter file = new System.IO.StreamWriter(@"C:\Users\msawicki\Desktop\UZ-Informatyka\Grafy-i-sieci\Lista4\ChinesePostman\ChinesePostman\ChnesePostmanGraphViz.txt"))
            {
                foreach (string line in lines)
                {
                    file.WriteLine(line);
